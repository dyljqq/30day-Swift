...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        /**
        anchorPoint = CGPoint(0.5, 0.5) //default
        - parameter x: position.x = frame.origin.x + anchorPoint.x * bounds.size.width；
        - parameter y: position.y = frame.origin.y + anchorPoint.y * bounds.size.height；
        */
